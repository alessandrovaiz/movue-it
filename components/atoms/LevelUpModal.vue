<template>
	<transition name="slide-fade">
		<div v-if="isLevelUpModalOpen" class="overlay flex justify-center items-center bg-gray-line fixed inset-0" @click="setModalState(false)">
			<div class="bg-white w-full max-w-md p-10 rounded-md shadow-lg text-center relative" @click.stop>
				...
				<button type="button" class="absolute right-2 top-2 bg-transparent border-0" @click="setModalState(false)">
